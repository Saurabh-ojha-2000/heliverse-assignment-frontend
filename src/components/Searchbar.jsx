...
const Searchbar = ({
  ...
  return (
    ...
    focus:outline-none focus:ring-2 focus:ring-opacity-50 text-black placeholder-black
  "
        type="text"
  ...
  "
    ...
    focus:outline-none focus:ring-2 focus:ring-opacity-50 text-black placeholder-black bg-[black]
  "
      >
